...
void main() {
  ...
  Playlist playlistExample =
      Playlist.mocked().copyWith(name: 'Example playlist');
  ...
  Future<void> createWidgetFor(WidgetTester tester) async {
    return await testEnvironment.openWith(
        tester, PlaylistPage(initialPlaylist: playlistExample));
  }
  ...
  void mockInitialResponses(int status) {
    ...
    when(testEnvironment.repositories
            ...
            .getDownloadStatusFor(playlistExample.products))
  ...
  group('Playlist page', () {
    ...
    group('IF user checks “Download all” toggle', () {
      testWidgets('THEN shows “Do you want to download all files?” popup',
        ...
        when(context.hypnosisAudioPlayer.playing).thenAnswer((_) => false);
        // Execution
