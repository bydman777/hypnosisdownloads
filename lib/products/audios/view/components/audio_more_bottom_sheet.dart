...
import 'package:hypnosis_downloads/playlists/playlist/view/components/move_to_playlist_bottom_sheet.dart';
...
class AudioMoreBottomSheet extends StatefulWidget {
  const AudioMoreBottomSheet({
    Key? key,
  ...
  @override
  State<AudioMoreBottomSheet> createState() => _AudioMoreBottomSheetState();
}

class _AudioMoreBottomSheetState extends State<AudioMoreBottomSheet> {
  @override
    ...
    return DefaultBottomSheetSkeleton(
      child: Column(
        children: [
          ...
          buildActionWidget(
            icon: SvgPicture.asset(IconsOutlined.musicSquareAdd),
            ...
            onTap: () {
              ...
              CustomBottomModalSheet.showBottomSheet.call(
                context: context,
                builder: (context) =>
                    MoveToPlaylistBottomSheet(audio: widget.downloadable.item),
              );
            },
          ),
          buildActionWidget(
