...
class YourAudioPackListView extends StatelessWidget {
  const YourAudioPackListView({Key? key, required this.yourAudioPacks})
      : super(key: key);

  final List<ProductPack> yourAudioPacks;
    ...
    return Padding(
      ...
      child: Column(
        children: [
          Row(
            children: [
              const HeadlineMediumText.dark('Your audio packs'),
              const Spacer(),
          ...
          _renderContent(filterPacks(context, yourAudioPacks)),
        ],
      ),
    );
  }
  ...
  Widget _renderContent(List<ProductPack> packs) {
    ...
    return ListView.separated(
      itemCount: yourAudioPacks.length,
      shrinkWrap: true,
      ...
      itemBuilder: (BuildContext context, int index) {
        final pack = yourAudioPacks[index];
  ...
  Widget buildEmptyWidget() {
    return const SizedBox(
      ...
      child: Row(
        ...
        children: [
          BodyMediumText.dark('No audio packs yet'),
        ],
      ),
    );
  }
...
class YourAudioPackLisViewItem extends StatelessWidget {
  const YourAudioPackLisViewItem({
    Key? key,
    required this.yourAudioPack,
    this.onTap,
  }) : super(key: key);

  final ProductPack yourAudioPack;
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  LabelText('${yourAudioPack.products.length} files')
                ],
              ),
            )
          ],
